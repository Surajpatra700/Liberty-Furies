...
class VerifyCodeGynecologistScreen extends StatefulWidget {
  final verifyId;
  final phoneNumber;
  const VerifyCodeGynecologistScreen(
      {super.key, required this.verifyId, required this.phoneNumber});

  @override
  State<VerifyCodeGynecologistScreen> createState() => _VerifyCodeGynecologistScreenState();
}

class _VerifyCodeGynecologistScreenState extends State<VerifyCodeGynecologistScreen> {
                  ...
                  onPressed: () async {
                    ...
                    await auth.signInWithCredential(credential).then((value) {
                      ...
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: ((context) => GynecologistForm())));
